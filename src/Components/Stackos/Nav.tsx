...
export default function Nav() {
  ...
  <div className="w-[95px]  relative bg-stone-950 rounded-[67.31px] shadow">
    <img src='/icons/stackos_logo.svg'></img>
  ...
  <div className="self-stretch  py-3 flex-col justify-center items-start gap-4 flex">
    <div className="self-stretch justify-center items-center gap-2 inline-flex">
      <div className="text-center text-white text-opacity-80 text-lg font-medium font-['Montserrat'] leading-snug">Log in with FusionX</div>
    </div>
  </div>
</div>
  </div>
